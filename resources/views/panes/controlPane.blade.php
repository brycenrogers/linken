<div class="container-control-pane">
    ...
    @endif
    <div class="col-md-7">
        <form class="form-inline pull-left" style="margin-bottom: 0;">
    ...
    <div class="container-account-pane col-md-5">
        <div class="dropdown pull-right">
            <button type="button" title="Logged in as {{ $user->name }}" class="user-photo" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="background-image: url({{ file_exists('uploads/' . $user->id . '.png') ? 'uploads/' . $user->id . '.png' : '/assets/images/default-user.png' }});">
            </button>
